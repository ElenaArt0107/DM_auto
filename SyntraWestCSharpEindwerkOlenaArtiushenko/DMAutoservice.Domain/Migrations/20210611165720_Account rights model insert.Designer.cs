...
namespace DMAutoservice.Domain.Migrations
{
    ...
    [Migration("20210611165720_Account rights model insert")]
    partial class Accountrightsmodelinsert
    {
            ...
            modelBuilder.Entity("DMAutoservice.Domain.Models.Account", b =>
                {
                    b.HasOne("DMAutoservice.Domain.Models.Person", "Person")
                        .WithOne("Log")
                        .HasForeignKey("DMAutoservice.Domain.Models.Account", "Id")
